...
int LIMIT_LOCAL_ITERATIONS_MIN = 10;
int LIMIT_LOCAL_ITERATIONS_MAX = 500;
std::vector<int> LOCAL_ITERATIONS_TO_TEST = {1000, 500, 250, 200, 100, 70, 50, 40, 35, 30, 25, 25, 20, 10, 5, 1};

int LIMIT_ITERATIONS_MIN = 5;
int LIMIT_ITERATIONS_MAX = 100;
std::vector<int> ITERATIONS_TO_TEST = {1, 2, 4, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 100, 200, 1000};

int NUMERO_REPETICOES_PERMITIDA_MIN = 10;
int NUMERO_REPETICOES_PERMITIDA_MAX = 100;
...
int main(){
    ...
    /// ============================== CRIAR A INSTANCIA DE TESTE ================================================

    // 
    for(int path{0}; path <= 0; ++path){

        // if(path == 0){
        //     SET_PATH_RELINKING = false;
        //     std::cout << "\n============================ VVVV  SEM PATH RELINKING!!!!!!   VVVV ============================\n";
        // }
        // else{
        //     std::cout << "\n============================ VVVV  COM PATH RELINKING!!!!!!   VVVV ============================\n";
        //     SET_PATH_RELINKING = true;
        // }

        // if(path == 0){
        //     USE_NUMERO_REPETICOES_PERMITIDA = false;
        //     USE_PRIMEIRO_VIZINHO_MELHOR = false;
        //     std::cout << "\n============================ VVVV  SEM NUMERO REP E SEM PRIMEIRO MELHOR VIZINHO!!!!!!   VVVV ============================\n";
        // }
        // else{
        //     USE_NUMERO_REPETICOES_PERMITIDA = true;
        //     USE_PRIMEIRO_VIZINHO_MELHOR = true;
        //     std::cout << "\n============================ VVVV  COM NUMERO REP E COM PRIMEIRO MELHOR VIZINHO!!!!!!!!!!!!   VVVV ============================\n";
        //     SET_PATH_RELINKING = true;
        // }



        for(int rep_permitido{NUMERO_REPETICOES_PERMITIDA_MIN}; rep_permitido <= NUMERO_REPETICOES_PERMITIDA_MAX; rep_permitido+=10){
            NUMERO_REPETICOES_PERMITIDA = rep_permitido;

            std::cout << "\n============================ VVVV  NUMERO REP = "<< rep_permitido << "  VVVV ============================\n";
        // for(int index_test{0}; index_test < ITERATIONS_TO_TEST.size(); ++index_test){
        //     LIMIT_ITERATIONS = ITERATIONS_TO_TEST[index_test];
        //     LIMIT_LOCAL_ITERATIONS = LOCAL_ITERATIONS_TO_TEST[index_test];
        //     std::cout << "\n============================ VVVV  IT = "<< ITERATIONS_TO_TEST[index_test] << " | LOCAL IT = " << LIMIT_LOCAL_ITERATIONS << "  VVVV ============================\n";
            ...
            std::cout << "Teste tal" << true;
            std::cout << "# Tempo medio : " << std::to_string(elapsed_time_mean) << "ms | Tempo min: " << std::to_string(time_min) << "ms | Tempo max: " << std::to_string(time_max) <<"ms | Média objetivo: " << media_objetivo <<" | Min objetivo: " << objetivo_min <<" | Max objetivo: " << objetivo_max << "\n\n";

        }
        /// ============================== FIM INSTANCIA DE TESTE ================================================
    }
